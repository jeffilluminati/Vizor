...
class AdminDiseaseRecyclerViewAdapter: RecyclerView.Adapter<AdminDiseaseRecyclerViewAdapter.ViewHolder>(){
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        init{
            ...
            itemView.setOnClickListener{
                ...
                navController.navigate(R.id.action_adminFragment_to_diseaseFragment2, bundle)
            }
        }
    }
